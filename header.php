...
<body>
    <header><div class="container"></div>
        ...
        <div class="container mt-5 mb-5">
            <div class="row">
                <div class="col-lg-6 col-md-12 col-sm-12 d-flex flex-column justify-content-center align-items-center mb-5">
                <h1 class="display-3"><b>Get the most fun <br/> weather app</b></h1>
                <h6 class="my-4">Simple, nice and user-friendly application of the<br/> weather. Only usefull information</h6>
